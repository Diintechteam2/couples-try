  ...
  return (
    <footer className="w-full bg-white">
      ...
      <div className="w-full bg-[#FFC1CC] pt-8 sm:pt-10 md:pt-12 lg:pt-16 xl:pt-20 pb-20 sm:pb-12 md:pb-16 lg:pb-20 xl:pb-24 px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 2xl:px-24">
        <div className="max-w-6xl lg:max-w-7xl xl:max-w-[1400px] 2xl:max-w-[1600px] mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 md:gap-10 lg:gap-12 xl:gap-16">
          {/* Logo & Community */}
          <div className="col-span-1 sm:col-span-2 lg:col-span-1 flex flex-col items-start">
            <div className="flex flex-col items-center sm:items-start flex-1 mb-4 sm:mb-6">
              <span className="text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-serif text-[#b73963] font-bold tracking-tight">Couples Try</span>
            </div>
            <h3 className="text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl font-cursive font-semibold mb-2 sm:mb-3 md:mb-4">Join Our Community</h3>
            <p className="mb-3 sm:mb-4 md:mb-6 text-sm sm:text-base md:text-lg lg:text-xl">Stay up to date with the new collections, products and exclusive offers</p>
          ...
          <div className="col-span-1">
            <h4 className="text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl font-cursive font-semibold mb-3 sm:mb-4 md:mb-6">Shop</h4>
            <ul className="space-y-1 sm:space-y-2 md:space-y-3 text-sm sm:text-base md:text-lg lg:text-xl">
          ...
          {/* Quick Links */}
          <div className="col-span-1">
            <h4 className="text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl font-cursive font-semibold mb-3 sm:mb-4 md:mb-6">Quick Links</h4>
            <ul className="space-y-1 sm:space-y-2 md:space-y-3 text-sm sm:text-base md:text-lg lg:text-xl">
              <li>About Us</li>
              <li>Contact Us</li>
          ...
          <div className="col-span-1 sm:col-span-2 lg:col-span-1">
            <h4 className="text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl font-cursive font-semibold mb-3 sm:mb-4 md:mb-6">Contact</h4>
            <div className="flex items-center gap-2 sm:gap-3 mb-2 sm:mb-3 md:mb-4">
              <Phone size={16} className="sm:w-5 sm:h-5 md:w-6 md:h-6 lg:w-7 lg:h-7 xl:w-8 xl:h-8" />
              <span className="text-sm sm:text-base md:text-lg lg:text-xl">+91 9971909625</span>
              <a 
              ...
              >
                <FaWhatsapp size={20} className="sm:w-6 sm:h-6 md:w-7 md:h-7 lg:w-8 lg:h-8 xl:w-10 xl:h-10" />
              </a>
            </div>
            <div className="flex items-center gap-2 sm:gap-3">
              <Mail size={16} className="sm:w-5 sm:h-5 md:w-6 md:h-6 lg:w-7 lg:h-7 xl:w-8 xl:h-8" />
              <span className="text-sm sm:text-base md:text-lg lg:text-xl">contact@couplestry.com</span>
            </div>
          </div>
        </div>
        
        <hr className="my-6 sm:my-8 md:my-10 lg:my-12 xl:my-16 border-gray-300" />
        
        <div className="text-center text-sm sm:text-base md:text-lg lg:text-xl xl:text-2xl text-gray-700 pb-2">
